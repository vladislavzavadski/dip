...
public class BrightOperation{
	...
	public static void mulOnConstant(BufferedImage image, int constant) throws IOException{
		...
		ImageIO.write(bufferedImage, "jpg", new File("result_mul.jpg"));
	}
	...
	public static void main(String[] args) throws IOException {
		...
		mulOnConstant(bufferedImage, constant);
